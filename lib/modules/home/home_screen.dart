                      ...
                      return Container(
                        ...
                        child: Text(
                          ...
                          style: AppTextStyle.black34.copyWith(
                              fontSize: context.isWebSiteScreen ? 64 : 24,
                  ...
                  children: [
                    ...
                    GridView.builder(
                        ...
                        itemBuilder: (context, index) {
                          Offset _imagePosition = Offset(100, 100);

                          // A unique key to make sure the widget can be properly identified during drag
                              ...
                              Column(
                                children: [
                                  Positioned(
                                    ...
                                    child: Draggable(
                                      feedback: model.supportCategoriesList[
                                                  index]['isSvg'] ==
                                              false
                                          ? Image.asset(
                                      ...
                                      // Empty widget during drag
                                      onDragEnd: (details) {
                                        setState(() {
                                          // Reset position after drag ends
                                          _imagePosition = Offset(100, 100);
                                        });
                                      },
              ...
              Container(
                ...
                child: context.isWebSiteScreen
                    ? Row(
                        ...
                        children:
                            List.generate(model.alliesList.length, (index) {
                          return Image.asset(
